...
namespace Assets
{
    ...
    PackageLoadResult PackageParser::loadPackage(const std::string &packagePath)
    {
        ...
        try
        {
            ...
            result.package.metadata.packagePath = packagePath;
    ...
    std::unique_ptr<AssetDefinition> PackageParser::parseAsset(const XmlNode &assetNode, PackageLoadResult &result)
    {
        ...
        return std::make_unique<AssetDefinition>(asset);
    }

    std::unique_ptr<MaterialAssetData> PackageParser::parseMaterialAsset(const XmlNode &node, PackageLoadResult &result)
    {
        ...
        return std::make_unique<MaterialAssetData>(data);
    }

    std::unique_ptr<MeshAssetData> PackageParser::parseMeshAsset(const XmlNode &node, PackageLoadResult &result)
    {
        MeshAssetData data;
        ...
        return std::make_unique<MeshAssetData>(data);
    }

    std::unique_ptr<TextureAssetData> PackageParser::parseTextureAsset(const XmlNode &node, PackageLoadResult &result)
    {
        ...
        return std::make_unique<TextureAssetData>(data);
    }

    std::unique_ptr<ShaderAssetData> PackageParser::parseShaderAsset(const XmlNode &node, PackageLoadResult &result)
    {
        ...
        return std::make_unique<ShaderAssetData>(data);
    }

    std::unique_ptr<AudioAssetData> PackageParser::parseAudioAsset(const XmlNode &node, PackageLoadResult &result)
    {
        AudioAssetData data;
        ...
        return std::make_unique<AudioAssetData>(data);
    }

    std::unique_ptr<SceneDefinition> PackageParser::parseScene(const XmlNode &sceneNode, PackageLoadResult &result)
    {
        ...
        return std::make_unique<SceneDefinition>(scene);
    }

    std::unique_ptr<EntityDefinition> PackageParser::parseEntity(const XmlNode &entityNode, PackageLoadResult &result)
    {
        ...
        return std::make_unique<EntityDefinition>(entity);
    }

    std::unique_ptr<Component> PackageParser::parseComponent(const XmlNode &componentNode, PackageLoadResult &result)
    {
        Component component;
